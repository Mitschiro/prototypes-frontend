    ...
    export default {
        ...
        methods: {
            createItem: async function () {
                try {
                    await axios.post(`${url}/api/write/new/category`, this.template);
            ...
            updateItem: async function () {
                try {
                    await axios.put(`${url}/api/update/category/${this.updateItemName}`, this.item);
                    this.$router.go('/admin');
                } catch (error) {
                    console.error(error);
            ...
            deleteItem: async function () {
                try {
                    await axios.delete(`${url}/api/delete/category/${this.deleteItemName}`);
                    this.$router.go('/admin');
                } catch (error) {
                    console.error(error);
        ...
        watch: {
            ...
            'updateItemName': async function (newV, oldV) {
                if (newV) {
                    let response = await axios.get(`${url}/api/category/${this.updateItemName}`);
